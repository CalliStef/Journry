...
<body class="bg-[#6B705C]">
    <main class="w-screen mt-20 flex flex-col items-center justify-center font-mono">
        ...
        foreach ($notes as $note) {
            ...
            echo "<div class='image-button absolute top-0 right-0 translate-x-3 -translate-y-4 w-12 h-12 text-[#F8F6F2] bg-[#CB997E] hover:bg-[#DDBEA9] font-medium rounded-full text-sm flex items-center justify-center'><span class='iconify text-[#F8F6F2] w-8 h-8' data-icon='ph:trash-fill'></span></div>";
